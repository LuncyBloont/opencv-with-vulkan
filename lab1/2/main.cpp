...
int main()
{
    ...
    getChannel(testImg.ptr(0), testImg.size().width, testImg.size().height, 1, 4, outputr.ptr(0), 1, 0);
    getChannel(testImg.ptr(0), testImg.size().width, testImg.size().height, 1, 4, outputg.ptr(0), 1, 1);
    getChannel(testImg.ptr(0), testImg.size().width, testImg.size().height, 1, 4, outputb.ptr(0), 1, 2);
    getChannel(testImg.ptr(0), testImg.size().width, testImg.size().height, 1, 4, outputa.ptr(0), 1, 3);
